...
@onready var house_scene = preload("res://sandbox/scenes/LevelSandbox/house_lvl_sandbox.tscn")
@onready var station_scene = preload("res://sandbox/scenes/LevelSandbox/station_lvl_sandbox.tscn")
